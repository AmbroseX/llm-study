...
[https://github.com/lm-sys/FastChat/blob/main/docs/model_support.md](https://github.com/lm-sys/FastChat/blob/main/docs/model_support.md)
...
## 如何支持新的模型
若要在 FastChat 中支持新模型，需要正确处理其提示模板和模型加载。目标是使以下命令在正确的提示下运行。
```shell
